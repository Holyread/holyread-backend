export const allowedOrigins = {
    ...
    development: ['https://localhost:4200', 'http://localhost:4200', 'https://dev-admin.holyreads.com', 'https://dev-customer.holyreads.com', 'https://www.holyreads.com', 'https://www.holyreads.com/'],
    staging: [''],
    production: [''],
}
