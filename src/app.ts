...
import customersAuthRoutes from './routes/customers-auth.routes'
import customersOnboardRoutes from './routes/customers-onboard.routes'
...
app.use('/api/v1/customers', customersOnboardRoutes)
app.use('/api/v1/customers', cors(corsOptionsDelegate), customersAuthRoutes)
